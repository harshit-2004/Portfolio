      ...
      <div className="container about__container">
        <div className="about__me">
          <div className="about__me-image">
            <img src={img} alt="Harshit Sharma" />
          </div>
        </div>
        <div className="about__content">
          ...
          <p>
            Able Full-stack Developer with expertise in building Web applications development.
            <br />
            My goal is to deliver efficient and effective solutions, and I adhere to the following principles in my work:
            <br />
            - I focus on providing solutions that address the problem needs and solve their problems.
            <br />
